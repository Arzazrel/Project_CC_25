...
/**
 * Class to implement a MapReduce total word count in the inputfiles, the simplest version.
 */
public class TotalWordCount
{
     ...
     */
    public static class TotalWordCountMapper extends Mapper<Object, Text, Text, IntWritable>
    {
        private final static IntWritable one = new IntWritable(1);  // var to set the value to associate with the found words
        private static final Text word = new Text("word");
     ...
     */
    public static class TotalWordCountReducer extends Reducer<Text, IntWritable, Text, IntWritable> {
