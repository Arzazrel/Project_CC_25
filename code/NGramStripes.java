...
public class NGramStripes
{
    ...
    public static class CoOccurrenceMapper extends Mapper<LongWritable, Text, Text, MapWritable>
    {
        ...
        protected void map(final LongWritable key,final Text value,final Context context)
            ...
            // now emit all the word and associated stripes -> format emit: (word,stripes) -> all word have a stripes (hash map) formatted in this way: ((word[i+1],...,word[i+w-1]), occurrence)
    ...
    public static void main(final String[] args) throws Exception {
        ...
        String jobName = "NGramStripes";            // name for the job
        ...
        while (successfulRuns < numRunsRequested)
        {
            ...
            job.setJarByClass(NGramStripes.class);
